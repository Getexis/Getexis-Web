...
<?php 	echo '<title>'.get_option('blogname').' | Maintenance Mode</title>'; ?>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<script type="text/javascript">//<![CDATA[ 
window.onload=function(){function s(e){function n(){i.currentSlide++;i.currentSlide=i.currentSlide%t.length;a(i,0);u(i,1e3,function(){i.src=t[i.currentSlide].src;o(i,1e3,function(){setTimeout(n,e)})})}setTimeout(n,e)}function o(e,t,n){var r=100;var i=t>r?Math.floor(t/r):0;var s=0;var o=function(){var t=s/r;a(e,t);s++;if(s<=r){setTimeout(o,i)}else{try{n()}catch(u){}}};o()}function u(e,t,n){var r=100;var i=t>r?Math.floor(t/r):0;var s=100;var o=function(){var t=s/r;a(e,t);s--;if(s>=0){setTimeout(o,i)}else{try{n()}catch(u){}}};o()}function a(e,t){e.style.opacity=t;var n=Math.ceil(t*100);e.style.filter="alpha(opacity="+n+")"}var e=["http://www.flaviak.com/pt/wp-content/plugins/smart-maintenance-mode/images/flavia_k_capa_01.jpg","http://www.flaviak.com/pt/wp-content/plugins/smart-maintenance-mode/images/flavia_k_capa_02.jpg","http://www.flaviak.com/pt/wp-content/plugins/smart-maintenance-mode/images/flavia_k_capa_03.jpg","http://www.flaviak.com/pt/wp-content/plugins/smart-maintenance-mode/images/flavia_k_capa_04.jpg"];var t=[];for(var n=0;n<e.length;n++){var r=new Image;r.src=e[n];t[n]=r}var i=document.images.slide;i.currentSlide=0;s(3e3)}//]]>  
</script>
<style type="text/css">
body {
	background: #000;
...
<body>
<div id="Logo">
<a href="http://www.flaviak.com/pt"><img src="http://www.flaviak.com/pt/wp-content/themes/Titan/images/logo_flavia_k_white.svg" alt="" width="170" height="70"></a>
<a href="mailto:contato@flaviak.com.br">
contato@<strong>flaviak</strong>.com.br
</a>
</div>
<div id="Display">
  <h1 style="margin: 200px 0 0;"><?php echo $smm_heading; ?> </h1>
  <div> <?php echo $smm_subheading; ?></div>
</div>
<img src="http://www.flaviak.com/pt/wp-content/plugins/smart-maintenance-mode/images/flavia_k_capa_01.jpg" name="slide" width="100%" alt="Maintenance Mode"> 
</body>
<?php

		if(!empty($smm_image) && file_exists(dirname(__FILE__).'/images/'.$smm_image)){
/*?>
			echo '<body style="background: #000;overflow: hidden;text-align: center;">'.'<div style="display: block;width: 100%;position: absolute;color: #fff; font-family: sans-serif;text-shadow: 0px 2px 5px #000;"><h1 style="margin: 200px 0 0;">'.$smm_heading.'</h1>'.'<div>'.$smm_subheading.'</div>'.'</div><img src="'.plugins_url('smart-maintenance-mode/images/'.$smm_image).'" style="height: 100%;" alt="Maintenance Mode"></body>';
<?php */
			exit;
...
<div class="wrap">
  ...
  <form action="options-general.php?page=smart-maintenance-mode" method="post" enctype="multipart/form-data">
    ...
    <table class="form-table">
      <tr>
        ...
        <td><input type="radio" <?php if(empty($disable_smm) || $_POST['disable_smm'] == 0) echo 'checked="checked"'; ?> name="disable_smm" value="0"/>
          Enabled &nbsp; &nbsp;
          <input type="radio" <?php if(!empty($disable_smm) || $_POST['disable_smm'] == 1) echo 'checked="checked"'; ?> name="disable_smm" value="1" />
          Disabled</td>
      </tr>
      <tr>
        <th scope="row" valign="top"><label for="smm_heading"><?php echo __('Heading','smart-maintenance-mode'); ?></label></th>
        <td><input type="text" size="25" value="<?php echo(htmlentities(isset($_POST['smm_heading']) ? stripslashes($_POST['smm_heading']) : (!empty($smm_heading) ? $smm_heading : ''))); ?>" name="smm_heading" id="smm_heading" />
          <?php echo __('Enter the Heading for Maintenance Mode page','smart-maintenance-mode'); ?><br />
          <br />
      ...
      <tr>
        ...
        <td><input type="text" size="25" value="<?php echo(htmlentities(isset($_POST['smm_subheading']) ? stripslashes($_POST['smm_subheading']) : (!empty($smm_subheading) ? $smm_subheading : ''))); ?>" name="smm_subheading" id="smm_subheading"/>
          <?php echo __('Enter the Sub Heading for Maintenance Mode page','smart-maintenance-mode'); ?><br />
          <br />
      ...
      <tr>
        ...
        <td><input type="file" name="smm_file" id="smm_file" />
          <?php echo __('This will display the image you upload on Maintenance mode page','smart-maintenance-mode'); ?><br />
          <br />
      ...
      <tr>
        ...
        <td>Year :
          ...
          <br />
          <br />
          <?php echo __('Choose the time when your site will be live. <br /><br />Maintenance Mode will be disabled once the Countdown date is crossed.','smart-maintenance-mode'); ?><br />
          <br />
          <?php echo __('Current Server Time is '.date('r'), 'smart-maintenance-mode'); ?><br />
          <br />
      ...
      <tr>
        ...
        <td><textarea rows="4" cols="50" name="smm_html" id="smm_html"><?php echo(htmlentities(isset($_POST['smm_html']) ? stripslashes($_POST['smm_html']) : (!empty($smm_html) ? $smm_html : ''))); ?></textarea>
          <br />
          <?php echo __('This will display Custom HTML content you provide on the Maintenance Mode page','smart-maintenance-mode'); ?><br />
          <br />
  ...
  5. Default Heading and Sub Heading<br />
  <br />
  <hr />
  ...
  <form action="options-general.php?page=smart-maintenance-mode" method="post">
    ...
    <table class="form-table">
      <tr>
        ...
        <td><input type="text" size="25" value="<?php echo((isset($_POST['start_ip']) ? trim($_POST['start_ip']) : '')); ?>" name="start_ip" id="start_ip"/>
          <?php echo __('Start IP of the range','smart-maintenance-mode'); ?><br /></td>
      </tr>
      <tr>
        <th scope="row" valign="top"><label for="end_ip"><?php echo __('End IP','smart-maintenance-mode'); ?></label></th>
        <td><input type="text" size="25" value="<?php echo((isset($_POST['end_ip']) ? trim($_POST['end_ip']) : '')); ?>" name="end_ip" id="end_ip"/>
          <?php echo __('End IP of the range','smart-maintenance-mode'); ?><br /></td>
      </tr>
      <tr>
        <th scope="row" valign="top"><?php echo __('Active','smart-maintenance-mode'); ?></th>
        <td><input type="checkbox" <?php if(!isset($_POST['add_iprange']) || smm_is_checked('status')) echo 'checked="checked"'; ?> name="status" />
          <?php echo __('Select the checkbox to set this range as active','smart-maintenance-mode'); ?><br /></td>
      </tr>
    </table>
    <br />
...
<br />
<br />
<?php echo __('The following IP ranges will see the actual site and other visitors will see the Maintenance Mode page. <a href="'.get_option('siteurl').'/?smm_preview=1">Preview Maintenance Mode</a>.','smart-maintenance-mode'); ?><br />
<br />
