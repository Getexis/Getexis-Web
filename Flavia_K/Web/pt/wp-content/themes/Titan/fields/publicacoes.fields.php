...
function post_type_portfolios() {
	$labels = array(
    	'name' => _x('Publicações', 'post type general name', THEMEDOMAIN),
    	'singular_name' => _x('Publicação', 'post type singular name', THEMEDOMAIN),
    	'add_new' => _x('Adicionar Nova Publicação', 'book', THEMEDOMAIN),
    	'add_new_item' => __('Adicionar Nova Publicação', THEMEDOMAIN),
    	'edit_item' => __('Editar Publicação', THEMEDOMAIN),
    	'new_item' => __('Adicionar Publicação', THEMEDOMAIN),
    	'view_item' => __('Visualizar Publicação', THEMEDOMAIN),
    	'search_items' => __('Pesquisar Publicação', THEMEDOMAIN),
    	'not_found' =>  __('Publicação Não Encontrada', THEMEDOMAIN),
    	'not_found_in_trash' => __('Publicação Não Encontrada no Lixo', THEMEDOMAIN), 
    	'parent_item_colon' => ''
	);		
	$args = array(
    	'labels' => $labels,
    	...
    	'show_ui' => true, 
    	'query_var' => true,
    	'rewrite' => array( 'slug' => 'publicacoes', 'with_front' => true ),
	...
	register_post_type( 'portfolios', $args );
  	...
  	$labels = array(			  
  	  'name' => _x( 'Categoria de Publicação', 'taxonomy general name', THEMEDOMAIN ),
  	  'singular_name' => _x( 'Categoria de Publicação', 'taxonomy singular name', THEMEDOMAIN ),
  	  'search_items' =>  __( 'Pesquisar Categoria de Publicação', THEMEDOMAIN ),
  	  'all_items' => __( 'Todas Categorias de Publicação', THEMEDOMAIN ),
  	  'parent_item' => __( 'Parent Portfolio Set', THEMEDOMAIN ),
  	  'parent_item_colon' => __( 'Parent Portfolio Set:', THEMEDOMAIN ),
  	  'edit_item' => __( 'Editar Categoria de Publicação', THEMEDOMAIN ), 
  	  'update_item' => __( 'Atualizar Categoria de Publicação', THEMEDOMAIN ),
  	  'add_new_item' => __( 'Adicionar Categoria de Publicação', THEMEDOMAIN ),
  	  'new_item_name' => __( 'Adcionar Nova Categoria de Publicação', THEMEDOMAIN ),
  	); 							  
...
$postmetas = 
	array (
		...
		'portfolios' => array(
			array("section" => "Content Type", "id" => "portfolio_type", "type" => "select", "title" => "Tipos:", "description" => "Modo de Visualização:", 
				"items" => array(
				/* ---- REMOVE ITEM ----/
