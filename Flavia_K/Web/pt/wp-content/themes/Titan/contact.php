...
<div id="page_content_wrapper" class="fade-in two">
    ...
    <div class="sidebar_content full_width transparentbg">
	    <div id="page_contacts" class="sidebar_content">
	    	...
	    	<!-- Begin main content -->
    			...
    			<form id="contact_form" method="post" action="<?php echo get_permalink($current_page->ID); ?>">
                    ...
                    <input id="your_name" name="your_name" type="text" class="required_field" title="<?php echo _e( 'Name', THEMEDOMAIN ); ?>*" style="width:93%" value="nome:" onblur="if (this.value == '') {this.value = 'nome:';}" onfocus="if (this.value == 'nome:') {this.value = '';}" /><br/>		
			    	<?php
                    	break;
						case 2:
			    	?>
                    <!--<label for="email"><?php echo _e( 'Email (required)', THEMEDOMAIN ); ?></label>-->
					<input id="email" name="email" type="text" class="required_field email" title="<?php echo _e( 'Email', THEMEDOMAIN ); ?>*" style="width:93%" value="e-mail:" onblur="if (this.value == '') {this.value = 'e-mail:';}" onfocus="if (this.value == 'e-mail:') {this.value = '';}" /><br/>			
			    	<?php
                    	break;
						case 3:
			    	?>
                    <!--<label for="message"><?php echo _e( 'Message (required)', THEMEDOMAIN ); ?></label>-->
                    <input id="phone" name="phone" type="text" title="<?php echo _e( 'Phone', THEMEDOMAIN ); ?>" style="width:93%" value="assunto:" onblur="if (this.value == '') {this.value = 'assunto:';}" onfocus="if (this.value == 'assunto:') {this.value = '';}" /><br/>		
			    	<?php
                    	break;
						case 4:
			    	?>
                    <label for="address"><?php echo _e( 'Address', THEMEDOMAIN ); ?></label>
                    <input id="address" name="address" type="text" title="<?php echo _e( 'Address', THEMEDOMAIN ); ?>" style="width:93%"/><br/>		
			    	<?php
                    	break;
						case 5:
			    	?>
					...
					<div id="contacts-form">
			        				...
			        				<textarea id="message" name="message" rows="7" cols="10" class="required_field" title="<?php echo _e( 'Message', THEMEDOMAIN ); ?>*" style="width:93%" value="mensagem:" onblur="if (this.value == '') {this.value = 'mensagem:';}" onfocus="if (this.value == 'mensagem:') {this.value = '';}"></textarea>
			        				<br/>		
			    	<?php
			    					break;
			    	...
			    	<div>
    					<input id="contact_clean_btn" type="reset" value="limpar"/>
    	...
    	<!-- End main content -->
          <div id="page_contacts" class="info_contacts">
                    <div id="contacts-form" class="number-contacts">
                    <a href="callto://+557191628584">
                    <font size="2">+55 71 </font><strong>9162 8584</strong>
                    </a>
		            </div>  
                    <div id="contacts-form" class="mail-contacts">
                    <a href="mailto:contato@flavia.com.br">contato@flaviak.com.br</a>
                    </div>  
                    </div>
    	</div>
