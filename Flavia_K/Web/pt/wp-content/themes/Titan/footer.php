...
<div class="footer_bar <?php if(isset($pp_homepage_style) && !empty($pp_homepage_style)) { echo $pp_homepage_style; } ?> fade-in two">
	<div class="footer_bar_wrapper">
	    <div class="social_wrapper">
	        <ul>
	            ...
	            <?php
	            	...
	            	{
	            ?>
	            <li><a title="Youtube" href="http://youtube.com/user/<?php echo $pp_youtube_username; ?>" target="_blank"><img width="45px" height="45px" src="<?php echo get_template_directory_uri(); ?>/images/social/youtube.png" alt=""/></a></li>
	            <?php
	            	}
	            ?>
	            <?php
                ...
                <?php
	            	...
	            	{
	            ?>
	            <li><a title="Facebook" href="http://facebook.com/<?php echo $pp_facebook_username; ?>" target="_blank"><img width="45px" height="45px" src="<?php echo get_template_directory_uri(); ?>/images/icon-facebook-flaviak.svg" alt=""/></a></li>
	            <?php
	            	}
	            ?>
	            <?php
	            	...
	            	{
	            ?>
	            <li><a title="Instagram" href="http://instagram.com/<?php echo $pp_instagram_username; ?>" target="_blank"><img width="45px" height="45px" src="<?php echo get_template_directory_uri(); ?>/images/icon-instagram-flaviak.svg" alt=""/></a></li>
	            <?php
	            	}
	            ?>
                <?php
	            	...
	            	{
	            ?>
	            <li><a title="Pinterest" href="http://pinterest.com/<?php echo $pp_pinterest_username; ?>" target="_blank"><img width="45px" height="45px" src="<?php echo get_template_directory_uri(); ?>/images/icon-pinterest-flaviak.svg" alt=""/></a></li>
	            <?php
	            	}
	            ?>
	        </ul>
	    ...
	    ?>
        <div id="estudio-roda-logo">
        <a href="https://www.facebook.com/estudiorodaoficial" title="Estúdio Roda"> Estúdio Roda </a>
        </div>
	    <div id="toTop">
