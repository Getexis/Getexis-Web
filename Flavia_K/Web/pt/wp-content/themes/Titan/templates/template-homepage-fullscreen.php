<div id="gallery-full-scren-home">
<div id="thumb-tray" class="load-item">
    <a id="prevslide" class="load-item"><img src="<?php echo get_template_directory_uri(); ?>/images/ic-arrow-left.svg" alt=""/></a>
    <a id="nextslide" class="load-item"><img src="<?php echo get_template_directory_uri(); ?>/images/ic-arrow-right.svg" alt=""/></a>
</div>
<?php
