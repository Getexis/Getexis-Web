...
<?php
	...
	{
?>
input[type=submit], input[type=reset], input[type=button], a.button, .button, #toTop:hover { 
	<?php /*background: echo $pp_button_bg_color; */ ?>;
    background: #d5d5d5;
}
...
?>
input[type=submit], input[type=reset], input[type=button], a.button, .button { 
	<?php  /*border: 1px solid echo $pp_button_border_color; */?>;
}
...
{
?>
#menu_wrapper .nav ul li a.hover, #menu_wrapper .nav ul li a:hover, #menu_wrapper div .nav li a.hover, #menu_wrapper div .nav li a:hover, #menu_wrapper .nav ul li ul li a:hover, #menu_wrapper .nav ul li ul li a:hover, #menu_wrapper div .nav li ul li a:hover, #menu_wrapper div .nav li ul li a:hover, #menu_wrapper div .nav li.current-menu-item ul li a:hover, #menu_wrapper div .nav li.current-menu-parent ul li a:hover { color: <?php echo $pp_menu_active_font_color; ?>;  }
#menu_wrapper .nav ul li a.hover, #menu_wrapper .nav ul li a:hover, #menu_wrapper div .nav li a.hover, #menu_wrapper div .nav li a:hover, #menu_wrapper div .nav li.current-menu-item > a, #menu_wrapper div .nav li.current-menu-parent > a, #menu_wrapper div .nav li.current-menu-ancestor > a, #menu_wrapper div .nav li ul li.current-menu-ancestor a
{
    ...
    background: <?php echo $pp_menu_hover_font_color; ?>;
}
<?php
}
...
.footer_bar { background:#fff !important;}
input[type=text], input[type=password], .woocommerce table.cart td.actions .coupon .input-text, .woocommerce-page table.cart td.actions .coupon .input-text, .woocommerce #content table.cart td.actions .coupon .input-text, .woocommerce-page #content table.cart td.actions .coupon .input-text, textarea
{
