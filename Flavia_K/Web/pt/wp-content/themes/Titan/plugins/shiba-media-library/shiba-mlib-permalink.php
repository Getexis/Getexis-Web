...
class Shiba_Media_Permalink {
	...
	function register_gallery_object($name = 'Gallery') {
		$labels = array(
			'name' => _x('Galerias', 'post type general name', THEMEDOMAIN),
			'singular_name' => _x('Galeria', 'post type singular name', THEMEDOMAIN),
			'add_new' => _x('Adcionar Nova Galeria', 'gallery', THEMEDOMAIN),
			'add_new_item' => __("Adcionar Nova Galeria", THEMEDOMAIN),
			'edit_item' => __("Editar Galeria", THEMEDOMAIN),
			'new_item' => __("Nova Galeria", THEMEDOMAIN),
			'view_item' => __("Visualizar Galeria", THEMEDOMAIN),
			'search_items' => __("Pesquisar Galeria", THEMEDOMAIN),
			'not_found' =>  __('Galeria Não Encontrada', THEMEDOMAIN),
			'not_found_in_trash' => __('Galeria Não Encontrada na Lixeira', THEMEDOMAIN), 
			'parent_item_colon' => ''
		  );
		  $args = array(
			'labels' => $labels,
