...
(function($){
	...
	$(document).ready(function() {
		$('#gallery-full-scren-home').append('<div id="supersized-loader"></div><ul id="supersized"></ul>');
    ...
    $.supersized = function(options){
			...
			while(thisSlide <= base.options.slides.length-1){
				...
				if(thisSlide == base.options.start_slide-1){
					...
					if (base.options.thumb_links){
						...
						thumbMarkers = thumbMarkers+'<li class="thumb'+thisSlide+' current-thumb"><a href="'+imageLink+'" class="fancy-gallery" rel="gallery" ><img src="'+thumbImage+'"/>teste</a></li>';
					};
				}else{
					// Slide links
					...
					if (base.options.thumb_links){
						base.options.slides[thisSlide].thumb ? thumbImage = base.options.slides[thisSlide].thumb : thumbImage = base.options.slides[thisSlide].image;
						thumbMarkers = thumbMarkers+'<li class="thumb'+thisSlide+'"><a href="'+imageLink+'" class="fancy-gallery" rel="gallery" ><img src="'+thumbImage+'"/>teste2</a></li>';
					};
				}
				thisSlide++;
			}
    	...
    	base._start = function(){
			...
			var linkTarget = base.options.new_window ? ' "href="' + api.getField('url') + '" target="_blank">' : '';
