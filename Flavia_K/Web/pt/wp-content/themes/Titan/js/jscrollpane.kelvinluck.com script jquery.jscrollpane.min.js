...
<body data-action='new' data-controller='client/client_user_sessions'>
<div id='login_root'>
<div class='tooltip'></div>
<div id='login_box'>

<form accept-charset="UTF-8" action="/client_user_session" class="new_client_user_session" id="new_client_user_session" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="nGIjp4dstcO+iFcN0+Q/FtygZu7zA0WVahfNDhod0bs=" /></div><div id='client_logo'><img alt="Logo-contra-labs" src="http://assets.mailee.me/clients/8947/logos/top/logo-contra-labs.png?1369429516" /></div>
<h2>
<strong>Login</strong>
</h2>
<div class='clear'></div>
<div id='caps' style='display:none'>
<div class='notice'>Você está com o CAPS LOCK ativado.</div>
</div>
<label for="client_user_session_login">Usuário ou email</label>
<br>
<input autocomplete="off" class="user_login" id="client_user_session_login" name="client_user_session[login]" size="30" tabindex="1" type="text" />
<br>
<br>
<label for="client_user_session_password">Senha</label>
<span class='quiet'>(<a href="/amnesia/new" title="Se você não lembra sua senha, nós podemos lhe enviar um email com instruções para definir uma nova senha.">esqueci minha senha</a>)</span>
<br>
<input class="user_password" id="client_user_session_password" name="client_user_session[password]" size="30" tabindex="2" type="password" />
<br>
<div class='footer_box'>
<div class='remember_me_box'>
<input name="client_user_session[remember_me]" type="hidden" value="0" /><input id="client_user_session_remember_me" name="client_user_session[remember_me]" tabindex="3" type="checkbox" value="1" />
<label class="remember_me_label" for="client_user_session_remember_me" title="Vamos guardar informações nesta máquina que manterão você logado no sistema. Não utilize esta função se você estiver em um lugar público.">Permanecer logado</label>
</div>
<div class='sign_in_button'>
<button class='mailee_button' tabindex='4' type='submit'>Entrar</button>
</div>
<div class='clear'></div>
</div>
...
<div id='login_footer'>
<a href="http://www.mailee.me/pt/index"><img alt="Logo" src="http://mailee.me/images/logo.png" style="height:35px" target="blank" title="Para o site &amp;raquo;" />
</a></div>
</div>
<script>
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-17717880-2']);
  _gaq.push(['_setDomainName', '.mailee.me']);
