...
<?php get_header();?>
    <!-- Begin content -->
<link rel="stylesheet" type="text/css" href="http://www.flaviak.com/pt/wp-content/themes/Titan/jcarousel/style.css">
<link rel="stylesheet" type="text/css" href="http://www.flaviak.com/pt/wp-content/themes/Titan/jcarousel/jcarousel.responsive.css">
<script type="text/javascript" src="http://www.flaviak.com/pt/wp-content/themes/Titan/jcarousel/jquery.js"></script>
<script type="text/javascript" src="http://www.flaviak.com/pt/wp-content/themes/Titan/jcarousel/jquery.jcarousel.min.js"></script>
<script type="text/javascript" src="http://www.flaviak.com/pt/wp-content/themes/Titan/jcarousel/jcarousel.responsive.js"></script>


<br class="clear"/>
</div>
<div id="page_content_wrapper" class="fade-in two" style="left: -170px;">
    <div class="inner">
    	<div class="inner_wrapper">
    	<div id="page_caption">
    		<h1 class="cufon" style="left:250px;"><?php echo $post->post_title; ?></h1>
            <div class="bg-page-caption-title" style="margin-left: -580px !important;"></div>
    	</div>
        <div id="page_main_content" class="sidebar_content full_width transparentbg scroll-pane" style="width:1280px;">
...
if($bg_style == 'Static Image'){
    ...
    wp_enqueue_script("script-supersized-gallery", get_template_directory_uri()."/templates/script-supersized-gallery?gallery_id=".$page_bg_gallery_id, false, THEMEVERSION, true);
	}
?>
...
?>
	<h5 id="subtitle" class="cufon"><?php echo $project_only->post_title; ?></h5>
