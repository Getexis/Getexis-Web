...
<link type="text/css" href="http://www.flaviak.com/pt/wp-content/themes/Titan/css/jquery.jscrollpane.css" rel="stylesheet" media="all" />
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
<!-- the mousewheel plugin -->
<script type="text/javascript" src="http://www.flaviak.com/pt/wp-content/themes/Titan/js/jquery.mousewheel.js"></script>
<!-- the jScrollPane script -->
<script type="text/javascript" src="http://www.flaviak.com/pt/wp-content/themes/Titan/js/jquery.jscrollpane.min.js"></script>
...
<div id="wrapper">
  <div class="top_bar fade-in one">
    <div id="menu_wrapper"> 
      ...
      <?php /*?>
					/* --------------------------------------
					REMOVE LOGO RETINA PNG AND OTHER FORMATS
					-----------------------------------------
					<img src="<?php echo $pp_retina_logo; ?>" alt="" width="<?php echo $pp_retina_logo_width; ?>" height="<?php echo $pp_retina_logo_height; ?>"/>
					-----------------------------------------
					<?php */?>
      <img src="http://www.flaviak.com/pt/wp-content/themes/Titan/images/logo_flavia_k.svg" alt="" width="100" height="100"/> </a>
      <?php
			    }
      ...
      <?php /*?>
					...
					<?php */?>
      <a id="custom_logo" class="logo_wrapper" href="<?php echo home_url(); ?>"> <img src="http://www.flaviak.com/pt/wp-content/themes/Titan/images/logo_flavia_k.svg" alt=""/> </a>
      <?php
			    }
			?>
      <!-- End logo --> 
