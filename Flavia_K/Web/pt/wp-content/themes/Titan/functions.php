...
if ( function_exists( 'add_image_size' ) ) { 
	...
	add_image_size( 'gallery_4', 215, 256, true );
...
include (get_template_directory() . "/fields/publicacoes.fields.php");
include (get_template_directory() . "/fields/projetos.fields.php");
